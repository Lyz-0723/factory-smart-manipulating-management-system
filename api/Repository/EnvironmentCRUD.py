...
async def get_environment_record() -> list[GetEnviromentRecord]:
    ...
    stmt = Environment.select().limit(10).order_by(Environment.c.env_record_id.desc())
...
async def create_environment_record(env_record: BaseEnvironmentRecord) -> bool:
...
async def delete_specific_environment_record(env_record_id: int) -> bool:
